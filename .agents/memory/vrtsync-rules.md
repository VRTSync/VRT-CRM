...
- Screenshot tool has no artifact registered here; for mobile-width checks, temporarily serve an iframe wrapper page from client/public and screenshot via externalUrl, then delete it.
